<?php
    ...
    mysqli_query($con,"INSERT INTO `teacher_info`( `t_name`, `t_add`, `t_ph`, `t_email`, `t_salary`, `pass`) VALUES ('$name','$add','$phone','$email','$slry','$password')");
	...
	<div class="content container">
            <div class="page-wrapper">
                <header class="page-heading clearfix">
                    <h1 class="heading-title pull-left">Insert Teacher</small></h1>
