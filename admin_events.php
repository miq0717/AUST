                          ...
                          <table class="table table-hover">
                              <thead>
                                ...
                                <?php
                                  ...
                                  $rslt=mysqli_query($con,"SELECT * from event");
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td>
                                      <a href="e_edit.php?id=<?php echo $row['e_id']; ?>">
                                        Edit
                                      </a>
                                    </td>
                                    <td>
                                      <a onclick="return confirm('do you really want to delete this?')"
                                        href="e_delete.php?id=<?php echo $row['e_id']; ?>">
                                        delete
                                      </a>
                                    </td>
                                  </tr>
                                ...
                                <tr>
                                    <td>
                                      <a href="e_insert.php?id=<?php echo $row['e_id']; ?>">
                                        Insert
                                      </a>
                                    </td>
                                  </tr>
