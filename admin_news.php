                          ...
                          <table class="table table-hover">
                              <thead>
                                ...
                                <?php
                                  ...
                                  $rslt=mysqli_query($con,"SELECT * from news");
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td>
                                      <a href="n_edit.php?id=<?php echo $row['news_id']; ?>">
                                        Edit
                                      </a>
                                    </td>
                                    <td>
                                      <a onclick="return confirm('do you really want to delete this?')"
                                        href="n_delete.php?id=<?php echo $row['news_id']; ?>">
                                        delete
                                      </a>
                                    </td>
                                  </tr>
                                ...
                                <tr>
                                    <td>
                                      <a href="n_insert.php?id=<?php echo $row['news_id']; ?>">
                                        Insert
                                      </a>
                                    </td>
                                  </tr>
